...
export function RecentTimeEntriesTable({ groups, clients, projects, readOnly, onEdit, onDelete, onUnmarkInvoiced, onArchive, onRestore }: RecentTimeEntriesTableProps) {
