...
export function toTimeEntry(r: ApiRecord): TimeEntry {
  return {
    ...
    entryType: r.entryType === "fixed" ? "fixed" : "time",
    fixedAmount: r.fixedAmount != null ? (r.fixedAmount as number) : undefined,
    clientId: r.clientId as string,
    projectId: (r.projectId as string) ?? undefined,
    date: r.date as string,
    startTime: (r.startTime as string) || "00:00",
    ...
    invoiceStatus: r.invoiceStatus as TimeEntry["invoiceStatus"],
